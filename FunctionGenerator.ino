/*
  Originally from https://www.arduino.cc/en/Tutorial/DueSimpleWaveformGenerator
  Link broken as of March 2021 so the sketch is reproduced here for reference
